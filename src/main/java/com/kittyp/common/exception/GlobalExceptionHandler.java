...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse<Void>> handleAccessDeniedException(
        ...
        response.setDetailedMessage("You don't have permission to access this resource");
        response.setTimestamp(LocalDateTime.now());

        log.error("Access denied exception at [{}]: {}", extractPath(request), ex.getMessage());
